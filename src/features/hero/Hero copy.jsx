...
function Hero() {
  ...
  return (
    ...
    >
      <motion.div
        className="mt-10 space-y-4 rounded-2xl border border-white/10 bg-black/10 p-8 shadow-[0_0_5px_5px_rgba(0,234,255,0.086)] backdrop-blur-sm transition-all duration-300 **:transition-all **:duration-300 group-hover:bg-black/20 group-hover:shadow-[0_0_10px_6px_rgba(0,234,255,0.18)] md:-mt-50 md:max-w-100"
      ...
      <motion.img
        ...
        className="z-10 -mt-30 ml-40 h-[40vh] opacity-85 transition-opacity duration-300 group-hover:opacity-100 md:mt-0 md:-ml-40 md:h-[75vh]"
